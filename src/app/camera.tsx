...
import { X, Image as ImageIcon, Zap, ZapOff, CheckCircle2, ArrowLeft } from 'lucide-react-native';
        ...
        <BlurView intensity={50} tint="light" style={styles.bottomPanel}>
          ...
          <View style={styles.controlsRow}>
            <TouchableOpacity style={styles.sideButton}>
              <IconContainer icon={<ImageIcon size={24} color={Colors.info} />} color={Colors.info} size={48} />
            ...
            >
              <View style={styles.shutterButtonOuter}>
                <LinearGradient
                  colors={scanned ? [Colors.success, Colors.success] : ['#8B7CF6', '#6C63FF']}
                  style={styles.shutterButtonInner}
                />
              </View>
            </TouchableOpacity>

            <TouchableOpacity style={styles.sideButton} onPress={() => setFlash(!flash)}>
              <IconContainer icon={flash ? <Zap size={24} color={Colors.warning} /> : <ZapOff size={24} color={Colors.warning} />} color={Colors.warning} size={48} />
