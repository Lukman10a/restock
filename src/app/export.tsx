      ...
      <View style={styles.modalOverlay}>
        ...
        <BlurView intensity={90} tint="light" style={styles.bottomSheet}>
          ...
          <View style={styles.formatCards}>
            ...
            >
              <IconContainer
                icon={<FileDown size={24} color={Colors.info} />}
                color={Colors.info}
                size={48}
              />
            ...
            >
              <IconContainer
                icon={<TableIcon size={24} color={Colors.success} />}
          ...
          <View style={styles.shareRow}>
            ...
            <TouchableOpacity style={styles.shareIcon}>
              <IconContainer
                icon={<Mail size={24} color={Colors.info} />}
                color={Colors.info}
                size={56}
              />
            </TouchableOpacity>
            <TouchableOpacity style={styles.shareIcon}>
              <IconContainer
                icon={<LinkIcon size={24} color={Colors.textSecondary} />}
